...
type Props = { className?: string; scheduleItems: EventDto[] } & HTMLAttributes<HTMLDivElement>;
const MainScheduleSlideContainer = ({ className, scheduleItems, ...props }: Readonly<Props>) => {
